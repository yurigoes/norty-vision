  ...
  return (
    <div className="space-y-4">
      ...
      {members.filter((m) => m.role === "owner").map((m) => (
        <div key={m.id} className="rounded-xl border border-line bg-bg/60 p-4">
      ...
      {support.length === 0 ? (
        <p className="rounded-xl border border-line bg-bg/60 p-6 text-center text-muted">Nenhum membro de suporte. Crie em <a href="/app/platform/team" className="text-brand hover:underline">Equipe</a>.</p>
      ) : support.map((m) => {
