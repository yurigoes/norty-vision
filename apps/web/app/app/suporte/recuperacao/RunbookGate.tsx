...
export function RunbookGate() {
  ...
  return (
    <div className="mx-auto max-w-md rounded-2xl border border-line bg-bg/60 p-6">
...
function Runbook({ sections }: { sections: Section[] }) {
  return (
    <div className="space-y-6">
      <nav className="rounded-xl border border-line bg-bg/60 p-4">
      ...
      {sections.map((s) => (
        <section key={s.id} id={s.id} className="scroll-mt-8 rounded-xl border border-line bg-bg/60 p-6">
